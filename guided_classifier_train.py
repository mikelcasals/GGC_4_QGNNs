...
parser.add_argument("--outdir", type=str, default = "prueba_fine_tuning", help="Output directory for the trained model")
parser.add_argument("--data_folder", type=str, default="data/k_closest16_graphdata_105000_train50000_valid5000_test50000_part_dist_maxabs/", help="Folder containing the graph data to bed fed to the autoencoder")
...
parser.add_argument("--num_layers", type=int, default=4, help="Number of layers in the quantum classifier")
...
parser.add_argument("--class_weight", type=float, default=0.5, help="Classification weight for the loss function")
