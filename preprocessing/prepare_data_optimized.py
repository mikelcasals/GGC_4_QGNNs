...
parser.add_argument('--num_samples', type=int, default=210000, help="Total number of data samples to use")
...
parser.add_argument('--train_samples', type=float, default=100000, help="Number of data samples to use for training")
parser.add_argument('--valid_samples', type=float, default=10000, help="Number of data samples to use for validation")
parser.add_argument('--test_samples', type=float, default=100000, help="Number of data samples to use for testing")
