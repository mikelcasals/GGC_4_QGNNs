...
parser.add_argument("--outdir", type=str, default = "SAG_model_more_data", help="Output directory for the trained model")
parser.add_argument("--data_folder", type=str, default="data/graphdata_105000_train50000_valid5000_test50000_part_dist_maxabs_old/", help="Folder containing the graph data to bed fed to the autoencoder")
...
parser.add_argument("--gae_type", type=str, default="SAG_model_edge", help="Type of autoencoder to be used (MIAGAE or SAG_model)")
